...
**How to read the timeline.** Start with [How Magic Context works](/concepts/how-it-works/#treat-the-execute-threshold-as-a-trigger): the execute percentage is a trigger, not a target, so a post-pass bar can land at any retained size.

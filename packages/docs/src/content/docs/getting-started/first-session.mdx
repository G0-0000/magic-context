...
Once Magic Context is installed and your harness is restarted, the session starts differently. This page walks through what you see; [How Magic Context works](/concepts/how-it-works/) explains why the percentages move.
...
- **Deeper concepts** are covered in [How Magic Context works](/concepts/how-it-works/), [Historian](/concepts/historian/), and [Memory](/concepts/memory/).

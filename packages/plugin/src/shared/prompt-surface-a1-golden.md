...
Generated by `packages/plugin/scripts/export-agent-surface.ts` at 2026-09-06.
Token counts are Claude BPE estimates on the raw text.

## 1. System-prompt guidance section

### PRIMARY full (reduce=on, memory=on, dreamer=on, temporal=on) — 8734 chars, ~2007 tokens
...
### PRIMARY memory-off (reduce=on, memory=off) — 7699 chars, ~1748 tokens
...
### SUBAGENT minimal — 699 chars, ~189 tokens
...
|---|---:|---|
| PRIMARY full | 8798 | `633d9ce5e078fa4745f881433c87953a` |
| PRIMARY memory-off | 7757 | `55ae43948fe17c992f58e7024ecc6ab3` |
| PRIMARY reduce-off | 6471 | `f5e8089b0ec037f8a81c648edd141913` |
| SUBAGENT minimal | 711 | `b7e4bbff867c435eb345862c9ed50e02` |

...
### PRIMARY full (reduce=on, memory=on, dreamer=on, temporal=on) — 8697 chars, ~1996 tokens
...
### PRIMARY memory-off (reduce=on, memory=off) — 7662 chars, ~1737 tokens
...
|---|---:|---|
| PRIMARY full | 8761 | `a3464eefad7aa053b837988040165d02` |
| PRIMARY memory-off | 7720 | `42873b64ca85e422357eedff397d87db` |

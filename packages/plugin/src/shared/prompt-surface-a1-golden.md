...
Generated by `packages/plugin/scripts/export-agent-surface.ts` at 2026-09-08.
Token counts are Claude BPE estimates on the raw text.

## 1. System-prompt guidance section

### PRIMARY full (reduce=on, memory=on, dreamer=on, temporal=on) — 8587 chars, ~1948 tokens
...
### PRIMARY memory-off (reduce=on, memory=off) — 7552 chars, ~1689 tokens
...
### PRIMARY reduce-off (reduce=off, memory=on) — 6199 chars, ~1395 tokens
...
|---|---:|---|
| PRIMARY full | 8651 | `5eb173018e4f269a1b0d1c2b06a898a5` |
| PRIMARY memory-off | 7610 | `4c4891d5da8aeb87e3ed5b44388724e2` |
| PRIMARY reduce-off | 6239 | `73f906d69529de68ea184e5ed233d7cd` |
